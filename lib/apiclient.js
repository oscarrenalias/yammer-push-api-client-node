...
var logger = winston.loggers.get("net.renalias.yammer.pushapi");    
...
YammerPushAPI.prototype.failHandler = function(error) {
...
YammerPushAPI.prototype.start = function() {
    ...
    return(self.doHandshake().then(function(handshake) {
        ...
        self.failHandler.call(self, error) 
    }));
}
...
YammerPushAPI.prototype.doSubscribeRequest = function(response) {
    logger.debug("Received response to subscribe request: " + response);
